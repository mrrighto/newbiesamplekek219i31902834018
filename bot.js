...
bot.on("messageReactionAdd", (reaction, user) => {
    ...
    if(reaction.message.channel.name == "welcome" && reaction.emoji.name == "seha8"){
      ...
      }else if (reaction.message.channel.name == "welcome" && reaction.emoji.identifier == "%E2%9C%85" && reaction.message.content == "**6.** **Merchant tag**, @rize#3801 will DM you specific items from the #marketplace, the items will be filtered based on what you did in this survey. __Press check if you want this feature__") {
