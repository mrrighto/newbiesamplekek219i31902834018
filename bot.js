...
bot.on("messageReactionAdd", (reaction, user) => {
    ...
    }else if (reaction.message.channel.name == "welcome" && reaction.emoji.identifier == "%31" && reaction.message.content.startsWith("**3.** **Press 1** if you are actively farming in Planar Gate.")) {
        target1.addRole('394384407940825101').catch(console.error);
    }else if (reaction.message.channel.name == "welcome" && reaction.emoji.identifier == "%32" && reaction.message.content.startsWith("**3.** **Press 1** if you are actively farming in Planar Gate.")) {
        target1.addRole('410302699867734018').catch(console.error);
    }else if (reaction.message.channel.name == "welcome" && reaction.emoji.identifier == "%33" && reaction.message.content.startsWith("**3.** **Press 1** if you are actively farming in Planar Gate.")) {
