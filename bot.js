...
bot.on("messageReactionAdd", (reaction, user) => {
	...
	target1.send("You already selected #2, please read the instructions du*b*k");       
	 target1.addRole('432384823068459018').catch(console.error);
                ...
                if (target1.roles.has("432877618954764289") || target1.roles.has("432384823068459018") || !target1.roles.has("522365368249876480") || target1.roles.has("521323904095223808") || target1.roles.has("432384941855080448")) return;
	target1.send("You already selected #3, please read the instructions du*b*k");  
	target1.addRole('522365368249876480').catch(console.error);
        ...
        if (target1.roles.has("432877618954764289") || target1.roles.has("432384823068459018") || target1.roles.has("522365368249876480") || !target1.roles.has("521323904095223808") || target1.roles.has("432384941855080448")) return;
	target1.send("You already selected #4, please read the instructions du*b*k");         
 target1.addRole('521323904095223808').catch(console.error);
               ...
               if (target1.roles.has("432877618954764289") || target1.roles.has("432384823068459018") || target1.roles.has("522365368249876480") || target1.roles.has("521323904095223808") || !target1.roles.has("432384941855080448")) return;
	target1.send("You already selected #5 (ping), please read the instructions du*b*k");   
